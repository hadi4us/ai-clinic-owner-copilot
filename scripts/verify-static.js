...
assertIncludes('gas/src/AuthService.js', [
  ...
  'getTrustedEffectiveUserEmail_',
  "getManifestWebExecuteAs_() !== 'USER_ACCESSING'",
  'effective_user_accessing',
  'loginDefaultPasswordSession',
  'PILOT_OWNER_PASSWORD_SHA256',
  'password_session',
...
assertIncludes('gas/src/SpreadsheetService.js', [
  ...
  'getActiveTenantId_',
  'SHEET_ROWS_CACHE_',
  'getSheetRowsCacheKey_',
  'getRowsAsObjectsForTenant_',
  'restoreActiveTenantContext_',
...
assertIncludes('gas/src/Config.js', [
  ...
  "resolvedTenantId === APP_CONFIG.defaultTenantId",
...
assertIncludes('gas/src/GrowthAssistantService.js', [
  ...
  'getGrowthAssistantPayloadCacheKey_',
  'CacheService.getScriptCache()',
...
assertIncludes('gas/src/DashboardService.js', [
  'invalidateGrowthAssistantCache_',
]);
...
assert(docs.includes('Version: `58`'), 'Docs must record the current versioned Apps Script version');
